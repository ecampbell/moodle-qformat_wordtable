...
if(($question = get_record('question', 'name', $qname))) {
	$redirect_url = "/question/preview.php?id=" . $question->id . "&courseid=" . $courseid;
	redirect($redirect_url);
}
// Should handle case where question not found and return a suitable error.
?>
