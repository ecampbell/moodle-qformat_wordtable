...
$plugin->version  = 2015090101;  // The current module version (Date: YYYYMMDDXX)
$plugin->maturity  = MATURITY_STABLE;  // Maturity level
$plugin->component  = 'qformat_wordtable';  // Plugin name
$plugin->release  = '3.3 (Build: 20150901)';  // The current module release in human-readable form (x.y)
