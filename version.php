...
$plugin->version  = 2015091602;  // The current module version (Date: YYYYMMDDXX)
$plugin->maturity  = MATURITY_STABLE;  // Maturity level
$plugin->component  = 'qformat_wordtable';  // Plugin name
$plugin->release  = '3.3.2 (Build: 20150916)';  // The current module release in human-readable form (x.y)
