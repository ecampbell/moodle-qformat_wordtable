...
$plugin->version  = 2015082101;  // The current module version (Date: YYYYMMDDXX)
$plugin->maturity  = MATURITY_STABLE;  // Maturity level
$plugin->component  = 'qformat_wordtable';  // Plugin name
$plugin->release  = '3.2.3 (Build: 20150821)';  // The current module release in human-readable form (x.y)
