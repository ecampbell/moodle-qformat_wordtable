...
$plugin->version  = 2015092301;  // The current module version (Date: YYYYMMDDXX)
$plugin->maturity  = MATURITY_STABLE;  // Maturity level
$plugin->component  = 'qformat_wordtable';  // Plugin name
$plugin->release  = '3.4.1 (Build: 20150923)';  // The current module release in human-readable form (x.y)
