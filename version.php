...
$plugin->version  = 2015070201;  // The current module version (Date: YYYYMMDDXX)
$plugin->maturity  = MATURITY_STABLE;  // Maturity level
$plugin->component  = 'qformat_wordtable';  // Plugin name
$plugin->release  = '3.1.5 (Build: 20150702)';  // The current module release in human-readable form (x.y)
