...
$plugin->version  = 2014050102;  // The current module version (Date: YYYYMMDDXX)
$plugin->maturity  = MATURITY_STABLE;  // Maturity level
$plugin->component  = 'qformat_wordtable';  // Plugin name
$plugin->release  = '2.8.1 (Build: 20140502)';  // The current module release in human-readable form (x.y)
