...
$plugin->version  = 2016010801;  // The current module version (Date: YYYYMMDDXX).
$plugin->maturity  = MATURITY_STABLE;  // Maturity level.
$plugin->component  = 'qformat_wordtable';  // Plugin name.
$plugin->release  = '3.5.5 (Build: 20160107)';  // The current module release in human-readable form (x.y).
