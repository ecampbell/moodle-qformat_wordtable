...
$plugin->version   = 2017041701;        // The current plugin version (Date: YYYYMMDDXX).
$plugin->maturity  = MATURITY_STABLE;  // Maturity level.
$plugin->component  = 'qformat_wordtable';  // Plugin name.
$plugin->release  = '3.5.15 (Build: 20170417)';  // The current module release in human-readable form (x.y).
