...
$plugin->version  = 2015092101;  // The current module version (Date: YYYYMMDDXX)
$plugin->maturity  = MATURITY_STABLE;  // Maturity level
$plugin->component  = 'qformat_wordtable';  // Plugin name
$plugin->release  = '3.4.0 (Build: 20150921)';  // The current module release in human-readable form (x.y)
