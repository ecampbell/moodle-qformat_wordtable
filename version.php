...
$plugin->version  = 2015080301;  // The current module version (Date: YYYYMMDDXX)
$plugin->maturity  = MATURITY_STABLE;  // Maturity level
$plugin->component  = 'qformat_wordtable';  // Plugin name
$plugin->release  = '3.2.1 (Build: 20150803)';  // The current module release in human-readable form (x.y)
