...
$plugin->version  = 2016103101;  // The current module version (Date: YYYYMMDDXX).
$plugin->maturity  = MATURITY_STABLE;  // Maturity level.
$plugin->component  = 'qformat_wordtable';  // Plugin name.
$plugin->release  = '3.5.10 (Build: 20161031)';  // The current module release in human-readable form (x.y).
